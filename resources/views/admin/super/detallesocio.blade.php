        ...
        <div class="box">
			<div class="box-header with-border">
               ...
               @if ($errors->any())
				...
				<form id="fr-listcliente-service" method="post" action="/admin/listasociados/{{ $socio_id }}" enctype="multipart/form-data">
					<div class="box-body">
						{{ csrf_field() }}
						<input name="_method" type="hidden" value="PUT">
						<input type="hidden" name="socio_id" id="socio_id" value="{{ $socio_id }}">
                              ...
                              <fieldset id="telefonos">
                                ...
                                @foreach($phones as $ph) 
                                  <div class="form-group stack">
                                      ...
                                      <input type="number" class="form-control" maxlength="20" name="phone[]" value="{{ $ph->phone }}">
                                  </div>
                                @endforeach
                              </fieldset>
					...
					<div class="modal-footer">
					   ...
					   <button type="submit" class="btn btn-danger btn-savess-glosario">Guardar</button>
				    </div>
				</form>
